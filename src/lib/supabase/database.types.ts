    ...
    Tables: {
      ...
      catalog_items: {
        Row: {
          ...
          metadata: Json;
          measure_back_height_cm: number | null;
          measure_back_width_cm: number | null;
          measure_front_height_cm: number | null;
          measure_front_width_cm: number | null;
          measure_long_sleeve_height_cm: number | null;
          measure_long_sleeve_width_cm: number | null;
          measure_short_sleeve_height_cm: number | null;
          measure_short_sleeve_width_cm: number | null;
          active: boolean;
          sort_order: number;
          created_at: string;
          updated_at: string;
