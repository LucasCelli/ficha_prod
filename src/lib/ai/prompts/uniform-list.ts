...
- Termos de modelo tambem nunca entram no campo nome: baby look, babylook, baby-look, bl, modelo feminino, feminino, regata e polo.
...
- Normalize baby look para baby_look.
...
- Se nao houver indicacao de baby look, regata ou polo, use modelo tradicional mesmo quando a linha falar adulto, infantil ou de criança.
...
- Se a ultima informacao da linha for PP, P, M, G, GG, XG, EXG, G1, G2, G3 ou G4, trate como tamanho.
...
- Em listas informais, PP, P, M, G, GG, XG, XXG, XXXG e XXXGG quase sempre indicam tamanho, principalmente quando nao aparecem logo apos o nome.
...
Tamanhos adultos aceitos: PP, P, M, G, GG, XG, XXG, XXXG, XXXGG, EXG, G1, G2, G3, G4.
Tamanhos infantis aceitos: 2, 4, 6, 8, 10, 12, 14, 16.
O campo tamanho deve ser string.

Mapeamentos:
- bl, baby look, babylook e baby-look => baby_look.
